# Hola, soy Claudio Durán 👋

Profesional TI orientado a soporte, automatización, análisis de datos y desarrollo de soluciones digitales con Power BI, Power Platform, Python y SQL.

## Sobre mí

Actualmente me desempeño en soporte TI y optimización de procesos internos, desarrollando soluciones orientadas a la digitalización, automatización y mejora de la gestión. Mi enfoque combina soporte operativo, análisis de datos y desarrollo de aplicaciones para resolver necesidades reales de negocio.

Me especializo en:
- automatización de procesos
- desarrollo de aplicaciones con Power Platform
- análisis, limpieza y transformación de datos
- construcción de dashboards e indicadores para toma de decisiones
- soporte TI y mejora continua de procesos

## Tecnologías y herramientas

- **Datos y BI:** Power BI, Excel, Power Query, SQL
- **Automatización y apps:** Power Apps, Power Automate, SharePoint, Forms, Outlook, Teams, OneDrive
...
- Excel aplicado a entornos laborales
- IA Generativa en el sector público
